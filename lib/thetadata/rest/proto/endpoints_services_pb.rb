...
# Source: endpoints.proto for package 'Endpoints'

require 'grpc'
require 'endpoints_pb'

module Endpoints
  module ThetaTerminal
    class Service
      ...
      self.service_name = 'Endpoints.ThetaTerminal'
      ...
      rpc :GetStockSnapshotMarketValue, ::Endpoints::StockSnapshotMarketValueRequest, stream(::Endpoints::ResponseData)
      ...
      rpc :GetOptionSnapshotMarketValue, ::Endpoints::OptionSnapshotMarketValueRequest, stream(::Endpoints::ResponseData)
      ...
      rpc :GetIndexSnapshotMarketValue, ::Endpoints::IndexSnapshotMarketValueRequest, stream(::Endpoints::ResponseData)
      ...
      rpc :GetInterestRateHistoryEod, ::Endpoints::InterestRateHistoryEodRequest, stream(::Endpoints::ResponseData)
    end
