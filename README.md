...
Set the path to your credentials file in the environment:

```sh
export THETADATA_CREDENTIALS_FILE=/example/theta_data_credentials.txt
```

Account credentials can also be read directly from the environment:

```sh
export THETADATA_ACCOUNT_EMAIL=user@example.com
export THETADATA_ACCOUNT_PASSWORD=oF8CDngbC98xyw4J
```
